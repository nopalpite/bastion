...
# on part du fichier vide livré dans l'image (/app/machines.yaml, sans
# machine ni salle de démo) plutôt que de planter au premier accès. Sans
# effet ensuite (le fichier copié persiste dans le volume, ne sera jamais
# réécrit ici).
